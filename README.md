# *Exercises for Programmers* in Elm
...
| Ex23 [x] [Troubleshooting Car Issues](src/Pages/Ex23.elm)     | | decision tree | 4(3)|
#### Chapter 5: Functions
| Exercise | dependencies | Memo  | Lv.  |
| -------- | -------------| ----- | -----:|
...
| Ex48 [x] [Grabbing the Weather](src/Pages/Ex48.elm)           | elm/http | SessionStora, port, JSON decode, HTTP Client| 4(3) |

...
initDict =
    Dict.fromList
        ...
        , ( 40, { init = \m -> { m | ex40Model = Just Ex40.init } } )
...
update msg model =
    ...
    case msg of
        ...
        Ex26Msg subMsg ->
            update_ .ex26Model subMsg Ex26.update (\m n -> { m | ex26Model = Just n }) Ex26Msg
        ...
        Ex40Msg subMsg ->
            update_ .ex40Model subMsg Ex40.update (\m n -> { m | ex40Model = Just n }) Ex40Msg

        Ex41Msg subMsg ->
            update_ .ex41Model subMsg Ex41.update (\m n -> { m | ex41Model = Just n }) Ex41Msg

        Ex46Msg subMsg ->
            update_ .ex46Model subMsg Ex46.update (\m n -> { m | ex46Model = Just n }) Ex46Msg
...
mainPane model =
    div [ style "flex" "1", style "padding" "20px" ]
        (case model.currentExercise of
            ...
            Just 26 ->
                mapMain model 26 .ex26Model Ex26.view Ex26Msg
            ...
            Just 40 ->
                mapMain model 40 .ex40Model Ex40.view Ex40Msg

            Just 41 ->
                mapMain model 41 .ex41Model Ex41.view Ex41Msg

            Just 46 ->
                mapMain model 46 .ex46Model Ex46.view Ex46Msg
